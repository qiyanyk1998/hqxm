...
<head>
    ...
    <script type="text/javascript">
        ...
        <%--        type:"post",--%>
        <%--        dataType:"json",--%>
        <%--        data:location.href="${pageContext.request.contextPath}/jsp/login.jsp"--%>
        <%--    })--%>
        <%--}--%>
    ...
    <div class="container-fluid">
        ...
        <div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a>${sessionScope.admin.username}</a></li>
                <li><a href="${pageContext.request.contextPath}/admin/exit" id="exit" onclick="exit()">退出登入</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<%--                                <li><a href="javascript:$('#centerLay').load('./user.jsp')">用户管理</a></li>--%>
                ...
                <div class="panel panel-info">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav">
                                <li><a href="javascript:$('#centerLay').load('./article1.jsp')">文章管理</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="${pageContext.request.contextPath}/images/8.jpg" alt="First slide">
